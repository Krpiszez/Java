...
public class GroceryShop {
    ...
    public void customerTransactions(){
        ...
        HashMap<String, String> goodsAndPrices = new HashMap<>();
        goodsAndPrices.put("Apple", moneyFormat.format(this.applePrice));
        goodsAndPrices.put("Banana", moneyFormat.format(this.bananaPrice));
        goodsAndPrices.put("Strawberry", moneyFormat.format(this.strawberryPrice));
        goodsAndPrices.put("Potato", moneyFormat.format(this.potatoPrice));
        goodsAndPrices.put("Tomato", moneyFormat.format(this.tomatoPrice));
